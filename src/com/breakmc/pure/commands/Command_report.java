...
public class Command_report extends BaseCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (Cooldowns.tryCooldown(((Player) sender).getUniqueId(), "Report", 120000)) {
            ...
            MessageManager.broadcast("pure.alert", "&7(&aReport&7) &a" + sender.getName() + " &7reported &a" + prof.getCurrentName() + " &7(" + (prof.isOnline() ? "&aOnline" : "&cOffline") + "&7) for " + StringUtils.join(args, " ", 1, args.length));
