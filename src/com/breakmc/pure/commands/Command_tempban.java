...
public class Command_tempban extends BaseCommand {
    ...
    public Command_tempban() {
        super("tempban", "pure.tempban", CommandUsageBy.ANYONE);
        setUsage("&cImproper usage! /tempban (name) (time) (reason)");
        setMinArgs(3);
        setMaxArgs(100);
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        try {
            ...
            pum.temporarilyBan(sender, prof.getUniqueID(), DateUtil.parseDateDiff(args[1], true), StringUtils.join(args, " ", 2, args.length));
