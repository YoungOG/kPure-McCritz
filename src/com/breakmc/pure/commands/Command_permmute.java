...
public class Command_permmute extends BaseCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        pum.permanentlyMute(sender, prof.getUniqueID(), StringUtils.join(args, " ", 1, args.length));
    }
