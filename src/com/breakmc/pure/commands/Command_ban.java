...
public class Command_ban extends BaseCommand {
    ...
    public Command_ban() {
        super("ban", "pure.ban", CommandUsageBy.ANYONE);
        setUsage("&cImproper Usage! /ban (player) (reason)");
        setMinArgs(2);
        setMaxArgs(100);
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        pum.permanentlyBan(sender, prof.getUniqueID(), StringUtils.join(args, " ", 1, args.length));
    }
