...
public class Command_banip extends BaseCommand {
    ...
    public Command_banip() {
        super("banip", "pure.banip", CommandUsageBy.ANYONE, "blacklist");
        setUsage("&cImproper Usage! /banip (player/ip) (reason)");
        setMinArgs(2);
        setMaxArgs(100);
    }
