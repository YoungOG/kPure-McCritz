...
public class Command_warn extends BaseCommand {
    ...
    public Command_warn() {
        super("warn", "pure.warn", CommandUsageBy.ANYONE);
        setUsage("&cImproper Usage! /warn (player) (reason)");
        setMinArgs(2);
        setMaxArgs(100);
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        pum.warn(sender, prof.getUniqueID(), StringUtils.join(args, " ", 1, args.length));
    }
