...
public class Profile {
    ...
    public Profile(Document document) {
        ...
        setLastUsedIP(document.getString("lastUsedIP"));
    ...
    public void lookup(CommandSender sender) {
        ...
        MessageManager.sendMessage(sender, "&7Online: " + (Bukkit.getPlayer(this.uniqueID) != null ? "&aTrue" : "&cFalse"));
        MessageManager.sendMessage(sender, "&7Playtime: &c" + DateUtil.readableTime(getPlaytime() * 1000));
        MessageManager.sendMessage(sender, "&7Last Used IP: &c" + getLastUsedIP());
