...
public class UUIDFetcher implements Callable<Entry<UUID, String>> {
    ...
    /**
     * UUID Fetcher v.2.0 by Max_Plays (02/14/2016) You may: - Use this class in
     * your project - Share it only with your friends You may not: - Re-upload
     * it on the internet - Pretend it belongs to you - Delete this note
    ...
    public Entry<UUID, String> call() throws Exception {
        ...
        UUID uuid = UUID.fromString(
                uuidString.substring(0, 8) + "-" + uuidString.substring(8, 12) + "-" + uuidString.substring(12, 16)
